...
if PYQT_VERSION < 0x50000 or QT_VERSION < 0x50000:
    sys.stderr.write('TortoiseHg requires at least Qt 5.0 and PyQt 5.0\n')
...
class QtRunner(QObject):
    ...
    def actionRegistry(self):
        # type: () -> shortcutregistry.ActionRegistry
